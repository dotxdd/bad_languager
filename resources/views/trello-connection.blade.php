        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <!-- Sprawdź, czy użytkownik ma już połączone Trello -->
                    @if (Auth::user()->tr_key)
                        <div class="mb-4">
                            <div class="text-sm font-medium text-blue-600 dark:text-blue-400 bg-blue-100 dark:bg-blue-800 p-4 rounded-lg font-retro" role="alert">
                                {{ __('Masz już połączone konto Trello.') }}
                            </div>
                        </div>

                        <!-- Przycisk do odłączenia Trello -->
                    ...
                    @else
                        <!-- Przycisk do połączenia z Trello -->
                        <div class="text-center">
                            <a href="{{ route('login.trello') }}" class="inline-block px-4 py-2 bg-blue-600 text-white text-sm font-retro rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-blue-700 dark:hover:bg-blue-600 dark:focus:ring-blue-400 transition duration-200">
                                {{ __('Połącz Trello') }}
                            </a>
                        </div>
                    @endif
